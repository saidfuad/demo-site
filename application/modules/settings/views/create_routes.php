...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        function generate_route(origin_place_id, destination_place_id, travel_mode,
            ...
            //var waypts = [];
//            stop = new google.maps.LatLng(-4.045411, 39.661355);
//		waypts.push({
//			location: stop,
//			stopover: false
//		});
//		
//		stop = new google.maps.LatLng(-4.043046, 39.659231);
//		waypts.push({
//			location: stop,
//			stopover: false
//		});
...
<div class="container-fluid fleet-view">
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-default" style="">
                <div class="panel-heading" style="background-color: #081833;">
                    <h3 class="panel-title" style="color: #fff; margin-top: 3px"><i class="fa fa-info-circle fa-fw"></i>Routes Details</h3>
                </div>
                    ...
                    <div class="col-md-12 bg-crumb">
                        ...
                        <form id="form-create-route">
                            <div class="form-group">
                                ...
                                <input class="form-control input-sm clear-input" name="route_name" id="route_name" type="text" placeholder="Type route name" required="required">
                            </div>

                            <div class="form-group">
                                <label>Route color <sup>*</sup></label>
                                <input type="text" class="form-control" id="full-popover" name="fill_color" value="#337ab7" data-color-format="hex" required="required">
                            </div>
                            <!--                                    <div class="form-group">
                                                                    <label>Allowed diversion distance (in KM)<sup>*</sup></label>
                                                                    <input type="number" class="form-control" id="allowed_diversion_distance" name="allowed_diversion_distance" min="0.2" max="5" step="0.1" required="required">
                                                                </div>-->
                            <div class="form-group">
                                <div class="row">
                            ...
                            <div class="form-group margin-top-10" style="border-top:1px solid #ccc;padding-top: 5px">
                                ...
                                <div class="col-sm-6 margin-top-10">
                                    <button class="btn btn-success btn-block" id="btn-create" type="submit">Create</button>
                                </div>
        ...
        <div class="col-sm-8">
            ...
            <div class="col-md-12" id='map_canvas' style="height:429px"></div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#form-create-route').on('submit', function () {

            var route_name = $('#route_name').val().trim();
            var fill_color = $('#full-popover').val().trim();
            ...
            if (route_name.length == 0 || fill_color.length == 0) {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    cache: false,
                    data: {data: data, route_name: route_name, fill_color: fill_color, raw_route: raw_route},
                    url: "<?php echo base_url('index.php/settings/save_route') ?>",
                    success: function (response) {
                        ...
                        if (response == 1) {
                            ...
                            //load_routes ();
                            swal({title: "Info", text: 'Route created successfully', type: 'success'}, function () {
