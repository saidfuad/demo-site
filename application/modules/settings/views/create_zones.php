    ...
    function initMap() {
        ...
        function confirm() {
            swal({
                ...
                confirmButtonText: 'Yes, Create Zone!',
        ...
        <div class="col-md-4 panel-default">
            <div class="panel panel-default" style="">
                <div class="panel-heading" style="background-color:#081833;">
                    <h3 class="panel-title" style="color: #fff; margin-top: 3px"><i class="fa fa-info-circle fa-fw"></i>Geofence Details</h3>
                    ...
                    <div class="col-md-12 bg-crumb" style="" >
                        ...
                        <form id="form-create-zone">
                            <div class="form-group">
                                ...
                                <input class="form-control input-sm clear-input" name="zone_name" id="zone_name" type="text" placeholder="Type geofence name" required="required">
                            </div>

                            <div class="form-group">
                                <label>Address</label>
                                <input class="form-control input-sm clear-input" id="address" name="address" type="text" placeholder="Enter address" >
                            </div>

                            <div class="form-group">
                                <label>Zone Colour <sup>*</sup></label>
                                <input type="text" class="form-control" id="full-popover" name="zone_color" value="#337ab7" data-color-format="hex" required="required">
                            </div>
                            ...
                            <div class="form-group margin-top-10" style="border-top:1px solid #ccc;padding-top: 5px">
                                ...
                                <div class="col-sm-6 margin-top-10">
                                    <button class="btn btn-success btn-block" id="btn-create">Create</button>
                                </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#form-create-zone').on('submit', function () {
            ...
            if (zone_name.length == 0 || zone_color.length == 0) {
            ...
            swal({
                ...
                $.ajax({
                    ...
                    cache: false,
                    data: data,
                    url: "<?php echo base_url('index.php/settings/save_geofence') ?>",
                    success: function (response) {
                        if (response == 1) {
                            ...
                            marker.setVisible(false);
                            load_zones();
                            swal({title: "Info", text: 'Geofence Created successfully', type: 'success'},
                                function(){
                                    document.location.href="<?php echo base_url('index.php/gps_tracking/geo_data')?>";
                                });

                        } else {
                            swal({title: "Info", text: 'Geofence creation failed, Try again.', type: 'error'});
