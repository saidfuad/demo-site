...
var device_anim<?php echo $time; ?>=true;
...
<div style='text-align: center;clear:both' id="bottomLoadingBar_<?php echo $prefix; ?>">
		...
		<div style="display:none" id="pbar_refresh_buttons_<?php echo $prefix; ?>">
			<div style="float:left;width:96%;height:2em;padding-top:0.2em;position:absolute;text-align:center"><input type='checkbox' checked='checked' onclick='stop_resume_toggle<?php echo $time; ?>()' id='timer_toggle<?php echo $time; ?>'> <?php echo $this->lang->line('data_refresh_after'); ?> <input type='text' size='2' onblur='counter_change<?php echo $time; ?>()' value='60' id='time_in_seconds<?php echo $time; ?>'> <?php echo $this->lang->line('seconds'); ?> <span style='display: inline-block;'>(<?php echo $this->lang->line('refresh_after'); ?> <span id='seconds<?php echo $time; ?>'>60</span>&nbsp;<?php echo $this->lang->line('second'); ?>)</span> &nbsp;&nbsp;<span onClick="directRefresh_live()" style="font-weight:bold;text-decoration:underline;cursor:pointer"><?php echo $this->lang->line('refresh'); ?></span><span id="live_settings<?php echo $time; ?>" style="font-weight: bold; float: right; margin-right: 14px; text-decoration: underline;cursor:pointer"><?php echo $this->lang->line("Settings"); ?></span>
			<?php if($this->session->userdata("show_map_history_button") == 1){ ?>
...
<?php 
	if($assets_category_id == 1 || $assets_category_id == "" || $assets_category_id == 0){
...
<div id="car<?php echo $prefix; ?>" style="color: white; background-image:url(<?php echo base_url(); ?>assets/<?php echo $image_type; ?>); font-family: 'Lucida Grande', 'Arial', sans-serif;font-size: 10px;text-align: center; width: 17px; height:33px; white-space: nowrap;margin-top:-20px;">
</div>
</div>
</div>
<script type="text/javascript">
...
/*	*/
	...
	$.post("<?php echo base_url(); ?>index.php/live/live_js",{prefix:<?php echo $prefix; ?>,time:<?php echo $time; ?>,lat:<?php echo $lat; ?>,lng:<?php echo $lng; ?>,angle:<?php echo $angle; ?>},function(data){
		$("body").append(data);
		setTimeout(function(){
