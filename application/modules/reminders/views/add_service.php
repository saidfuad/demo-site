            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="reservation">Service Company<sup title="Required field">*</sup>:</label>
                            <input class="form-control" type="text" name="company" id="company" />
                        </div>
                        <div class="form-group">
                            <label for="reservation">Service Type<sup title="Required field">*</sup>:</label>
                            <input class="form-control" type="text" name="service_type" id="service_type" />
                        </div>
                     ...
                     <div class="col-md-6">
                         <div class="form-group">
                            <label for="reservation">Amount To Pay For Service<sup title="Required field">*</sup>:</label>
                            <input class="form-control" type="number" name="amount_to_pay" id="amount_to_pay"/>
                        </div>

                         <div class="form-group">
                            <label for="reservation">Date To Service Vehicle<sup title="Required field">*</sup>:</label>
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <input class="form-control" type="text" name="reminder_type_id" id="reminder_type_id" value="<?php echo 3; ?>" />
                        </div>
                        <br>
...
<script>
    ...
    $(function () {
        ...
        $('#add-service-form').on('submit', function () {

            var $this = $(this);

            if ($('#vehicle_id').val().trim().length == 0 || $('#company').val().trim().length == 0 || $('#expiry_date').val().trim().length == 0 || $('#service_type').val().trim().length == 0 || $('#amount_to_pay').val().trim().length == 0 || $('#reminder_time').val().trim().length == 0 ) {
