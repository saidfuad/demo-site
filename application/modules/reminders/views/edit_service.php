                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       ...
                       <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="service_type" id="service_type" value="<?php echo $reminder['service_type'];?>"/>
                        </div>
...
<script>
    ...
    $(function () {
        ...
        $('#edit-service-form').on('submit', function () {
            ...
            if ($('#vehicle_id').val().trim().length == 0 || $('#company').val().trim().length == 0 || $('#service_type').val().trim().length == 0 || $('#amount_to_pay').val().trim().length == 0 || $('#reminder_time').val().trim().length == 0 ) {
