...
<div class="container-fluid fleet-view">
    <div class="row" style="margin-top: -180px">
        <div class='input-prepend input-group' id="datepick" > <span class='add-on input-group-addon' >
            ...
            <input type="text" style="width: 300px" name="daterange" id="daterange" style=" margin-right: 16px; margin-bottom: 16px" class="form-control" value="" /> &nbsp;
            <button class="btn btn-success btn-sm"  style=" margin-right: 16px; margin-bottom: 16px" onclick="pause()">pause</button> &nbsp;
            <button class="btn btn-success btn-sm" style=" margin-right: 16px; margin-bottom: 16px" onclick="play()" >continue</button>
                
              <a data-toggle='tooltip' data-original-title="Click to view playback" style=" float:right; margin-right: 250px; margin-bottom: 16px" href="<?php echo " ".site_url('gps_history/view_history/'.$vehicle_id)." "; ?>" class="btn btn-primary btn-sm"> View History </a>
            
              <a data-toggle='tooltip' data-original-title="Click to view vehicle details" style="float:right; margin-right: 16px; margin-bottom: 16px" href="<?php echo " ".site_url('vehicles/fetch_vehicle/'.$vehicle_id)." "; ?>" class="btn btn-primary btn-sm">  Vehicle Details </a>
        </div>
        <div class="overlay_no_devices">
            <div class="col-md-12" style="margin-top:160px; margin-left: 16px; padding: 0">
                <div class="row">
