...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        var lat, lon;
        pathCoords = <?php echo $coords; ?>;
        if (pathCoords.length > 1) {
            lat = pathCoords[0].latitude;
            lon = pathCoords[0].longitude;
       ...
       var path = [];
        ...
        {
          path.push(pathCoords[i].latitude + "," + pathCoords[i].longitude );
          paths.push(pathCoords[i].latitude + "," + pathCoords[i].longitude + "," + pathCoords[i].tracking_time);
        }
        ...
        if (pathCoords.length > 1) {
            ...
            console.log("Distance: " + distance + " pathCoords.length " + pathCoords.length);
            ...
            // pathCoords = getDistinctRoute(null);
            routes_array = drawRoute(map, pathCoords, routes_array);
            // createSnapToRoadPath();
