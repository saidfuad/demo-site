                ...
                <div class="submit_order col-xs-6 col-md-5 col-md-offset-3 bg-crumb" align="center">
                    ...
                    <div id="pending_payment">
                        <div style="margin:0; padding:0" class="col-md-12 col-lg-12">
                           <?php if($pending_order['mpesa']==1){?>
                                    <b><h4>Your Payment Is Being Processed By Hawk System.Waiting Payment Approval</h4></b>
                                <?php }else{?>
                            ...
                            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="panel-body">
                                    <ul type="disc">
                                        ...
                                        <li>Input <b>883473</b>,Click OK</li>
                                        <li>Select <b>Account No</b></li>
                                        <li>Input <b><?php echo $pending_order['order_id']; ?></b>,Click OK</li>
                                        <li>Input <b><?php echo $pending_order['amount']; ?></b>,Click OK</li>
