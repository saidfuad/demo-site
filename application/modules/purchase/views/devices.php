                ...
                <div class="col-xs-6 col-md-3">
                    <div class="product_device bg-crumb device" align="center">
                        ...
                        <form id="form-device">
                            ...
                            <button data-toggle='tooltip' data-original-title='Click to add device to your cart.' data-placement='bottom' type="submit" class="btn btn-success" id="addCart1">Add to Cart</button>
                            <br>
