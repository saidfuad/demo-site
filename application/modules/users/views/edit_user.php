                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <select name="assign[]" id="assign" class="chzn col-md-12 form-control" multiple="multiple" >
                                 <?php $i=1;$j=1; foreach ($assign as $new) {
                                foreach ($assigned as $neww) {
                                  if($neww->vehicle_id==$new->vehicle_id){?>
                                     <option selected="selected" value="<?php echo $new->vehicle_id;?>"><?php echo $i.". ".$new->model." - ".$new->plate_no;?></option>

                                   <?php $sell=1;}else{$sell=0;}
                           ++$j;}if($sell==0){?>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                ...
                                function (){
                                    document.location.href="<?php echo base_url('index.php/users/fetch_user/'.$user['user_id']) ?>";
                                });
                            } else {
