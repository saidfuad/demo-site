                    ...
                    <table class="table table-striped table-hover" id="dataTables-example">
                        ...
                        <?php foreach ($personnel as $key => $value) { ?>
                           <tr class="gradeU">
                                ...
                                <td><?php echo "<a data-placement='top' data-toggle='tooltip' data-original-title='Delete Personnel' href='".base_url('index.php/personnel/delete_personnel/'.$value->personnel_id)
                                            ...
                                            <a data-placement='top' data-toggle='tooltip' data-original-title='View Personneler' href='".base_url('index.php/personnel/v_personnel/'.$value->personnel_id)
                                                ."'class='btn btn-info btn-xs'><span class='fa fa-eye'></span></a>
                                                <a data-placement='top' data-toggle='tooltip' data-original-title='Edit Personnel' href='".base_url('index.php/personnel/edit_personnel/'.$value->personnel_id)
