            ...
            <nav id="menu" class="navbar-default navbar-fixed-side hidden-xs" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="<?php if(str_replace('/hawk/index.php/',"",$_SERVER['REQUEST_URI']) == 'normal'){ echo 'active'; } ?>" href="<?php echo site_url('normal') ?>"> <i class="fa fa-map-marker fa-fw"></i>Locate Vehicle </a>
                        </li>
                        
                        <li> <a class="<?php
                            if(str_replace('/hawk/index.php/',"",$_SERVER['REQUEST_URI']) == 'normal/vehicles' )
                            { echo 'active'; }
                            ?>" href="<?php echo site_url('normal/vehicles') ?>"><i class="fa fa-automobile fa-fw"></i>View Vehicles
                           </a> </li>
                        ...
                        <?php if (sizeof($this->cart->contents()) != 0) { ?>
                            <div class="col-sm-6 col-md-6 ">
                                <a href="<?php echo site_url('purchase/checkout'); ?>" style="color: #131b26">
                                    <div data-toggle='tooltip' data-original-title='Click to checkout and submit your order' data-placement='left' style="position:absolute; top:24px; right: 48px"> <span class="fa fa-lg fa-shopping-cart" style="font-size: 48px"></span> </div> <span class="badge" style="color:#131b26; background: #c1d72e; position:absolute; top:18px; right: 36px"><?php echo sizeof($this->cart->contents()); ?></span> </a>
                            </div>
                            <?php } ?>
                    </div>
                </div>
