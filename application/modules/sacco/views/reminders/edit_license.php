                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                ...
                                <label for="reservation">Choose User<sup title="Required field">*</sup>:</label>
                                    <select name="driver_id" id="driver_id" class="form-control">
                                        <?php foreach($drivers as $new) {
                                            $sel = "";
                                            if($reminder['driver_id']==$new->user_id){?>
                                                <option selected="selected" value="<?php echo $new->user_id;?>"><?php echo $new->first_name." ".$new->last_name;?></option>
                                            <?php }else{?>
                                                <option value="<?php echo $new->user_id;?>"><?php echo $new->first_name." - ".$new->last_name;?></option>
                                            <?php }
                                        }
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="license_number" id="license_number" value="<?php echo $reminder['license_number']?>" />
                        </div>
...
<script>
    ...
    $(function () {
        ...
        $('#edit-license-form').on('submit', function () {
            ...
            swal({
                ...
                $.ajax({
                    method: 'post',
                    url: '<?= base_url('index.php/sacco/update_reminder') ?>',
                    data: $this.serialize(),
