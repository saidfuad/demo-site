            ...
            <nav id="menu" class="navbar-default navbar-fixed-side hidden-xs" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="<?php if(str_replace('/hawk/index.php/',"",$_SERVER['REQUEST_URI']) == ''){ echo 'active'; } ?>" href="<?php echo site_url('sacco') ?>"> <i class="fa fa-map-marker fa-fw"></i>Locate Vehicle </a>
                        </li>
                        <li> <a class="<?php
                            if(str_replace('/hawk/index.php/sacco/',"",$_SERVER['REQUEST_URI']) == 'vehicles')
                            { echo 'active'; }
                            ?>" href="<?php echo site_url('sacco/vehicles') ?>"><i class="fa fa-automobile fa-fw"></i>View Vehicles</a> </li>
                   
                          <li> <a class="<?php
                            if(str_replace('/hawk/index.php/sacco/',"",$_SERVER['REQUEST_URI']) == 'reminders')
                            { echo 'active'; }
                            ?>" href="<?php echo site_url('sacco/reminders') ?>"><i class="fa fa-history fa-fw"></i>Reminders</a> </li>
                  </ul>
                    <!-- /#side-menu -->
                </div>
                <!-- /.sidebar-collapse -->
