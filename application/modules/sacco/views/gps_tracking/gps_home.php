...
<?php if (sizeof($vehicles) == 0 && $this->session->userdata('hawk_user_type_id') != '7') { ?>
    ...
    <div class="no-vehicle-overlay">
        ...
        <div class="col-sm-5 col-md-5 bg-crumb no-vehicle-title" align="center">
            ...
            <p>Your SACCO currently has no vehicles tracked.</p>
    ...
    <div class="row" style="margin-top: -64px">
       ...
       <!--         <div data-toggle='tooltip' data-original-title='Click to show a list of all of your vehicles. Toggle to hide.' data-placement='right' class="controls" id="map-vehicle-zone">
                ...
                <div id="filter-by-sacco">
                    <select class="form-control" id="filter-owner">
                        <option value="">All Owners</option>
                        <?php foreach($owners as $owner){ ?>
                        <option value="<?php echo $owner->user_id; ?>"><?php echo $owner->first_name. " ".$owner->last_name; ?></option>
                        <?php } ?>
                    </select>
                </div>
...
<script type="text/javascript">
    $(function () {
        ...
        function refresh_vehicle_locations(times) {
            ...
            var owner_id  =  $('#filter-owner').val().trim();
            ...
            $.ajax({
                ...
                , url: "<?php echo base_url('index.php/sacco/refresh_grid') ?>"
        ...
        function displayMarkers(res)
        {
            ...
            var markers = res.map(function(res, i) {
                ...
                $marker_type = 'vehicle';
                $fetch_vehicle_url = "<?php echo site_url('sacco/fetch_vehicle'); ?>";
                $fetch_vehicle_url = $fetch_vehicle_url + "/" + res.vehicle_id;
                $vehicle_history_url = " <?php echo site_url('sacco/view_history'); ?>";
        ...
        $('#filter-owner').change(function(){
            ...
            filter_grid(owner_id);
        });

        function filter_grid(owner_id) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('index.php/sacco/filter_grid') ?>",
                success: function (response) {
                    res = JSON.parse(response);
                    displayMarkers(res);
                }
