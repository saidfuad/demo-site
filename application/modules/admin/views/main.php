                ...
                <ul class="nav navbar-top-links navbar-right hidden-xs">
                    <?php if($this->session->userdata('hawk_user_type_id') != '7'){ ?>
                        <ul class="nav navbar-top-links navbar-left mega-menu hidden-xs hidden-sm">
                            <li>
                                <a data-toggle='tooltip' data-original-title='Generate a list of reports for your vehicles and be able to print or export them.' data-placement='bottom' class="nav-items pop-report-panel" href="<?php echo site_url('reports') ?>"> <i style="color:#c1d72e" class="fa fa-files-o fa-fw"></i> &nbsp; Reports </a>
                            </li>
                        </ul>
                        <?php } ?>
                            <li> <a data-toggle='tooltip' data-original-title='Log off the system' data-placement='bottom' class="nav-items" href="<?php echo base_url('index.php/login/logout'); ?>">Logout <i style="color:#c1d72e" class="fa fa-sign-out fa-fw"></i></a> </li>
                            <!--<li class="dropdown">
            ...
            <nav id="menu" class="navbar-default navbar-fixed-side hidden-xs" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li> <a href="<?php echo site_url('admin/devices') ?>"><i class="fa fa-automobile fa-fw"></i>&nbsp;<b>Devices</b><span class="label label-info pull-right"><?php echo $d; ?></span></a> </li>
                        <li>
                            <a href="<?php echo site_url('admin/users/clients'); ?>"> <i class="fa fa-group"></i> &nbsp;<b>Clients</b> </a>
                        </li>
                         <li>
                            <a href="<?php echo site_url('admin/sacco'); ?>"> <i class="fa fa-group"></i> &nbsp;<b>SACCO</b> </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('admin/devices/mpesa') ?>"> <i class="fa fa-money fa-fw"></i> <b>Mpesa</b> </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('admin/users'); ?>"> <i class="fa fa-group"></i> &nbsp;<b>Installers</b> </a>
                        </li>
                    </ul>
                    <!-- /#side-menu -->
                </div>
