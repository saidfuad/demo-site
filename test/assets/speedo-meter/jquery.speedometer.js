...
( function( $ ){
	...
	$.fn.speedometer = function( options ){
		...
		var def = {
			...
			thisCss: {
				...
				fontFamily: 'Arial',
				fontWeight: '900',
				backgroundImage : "url('"+base_url+"assets/speedo-meter/background-new.jpg')"
		...
		if ( def.limit && ( def.percentage > def.maximum || def.percentage < def.minimum ) ) {
			/* the glass cracks */
			$this.css( 'backgroundImage' , 'url("'+base_url+'/assets/speedo-meter/background-broken.jpg")' );
		} else {
	...
	//for small
	$.fn.speedometer1 = function( options ){
		...
		var def = {
			...
			thisCss: {
				...
				fontFamily: 'Arial',
				fontWeight: '900',
				backgroundImage : "url('"+base_url+"assets/speedo-meter/background-small.jpg')"
