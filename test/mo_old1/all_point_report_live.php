		...
		<!--	<table width='100%' id='table' border="1" style='font-size:12px !important'>
				...
				if($address[0]>6){
					...
					$address=$address[0]." ".$address[1];
						...
						echo '<tr><td>'.date($_SESSION['date_format']." ".$_SESSION['time_format'],strtotime($row['add_date'])).'</td><td>'.$address.'</td><td style="text-align:center">'.$row['speed'].'</td></tr>';
					}
					echo $footer;
			?>
	<!--	</table>-->
