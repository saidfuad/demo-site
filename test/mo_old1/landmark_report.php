...
<?php $device_id = $_REQUEST['device']; ?>
	...
	<center><h3><?php echo $lang['Landmark Report']; ?></h3></center>
	...
	<div data-role="content">
		...
		<!--	<table width='100%' id='table' border="1" style='font-size:12px !important'>
				...
				<?php
					...
					{
						echo "<div data-role='collapsible-set' data-theme='b' data-content-theme=''><div data-role='collapsible' data-collapsed=''><h3>".$row['device_name']."</h3><div data-role='fieldcontain'><b>".$lang['Landmark Name'] ." : </b>".$row['landmark_name']."<br><b>".$lang['Date Time'] ." : </b>".date($_SESSION['date_format']." ".$_SESSION['time_format'],strtotime($row['date_time']))."<br><b>".$lang['Distance'] ." : </b>".$row['distance']." </div></div></div>";
					}
			?>
	<!--	</table>-->
	</div>
