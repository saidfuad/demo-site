...
<?php $device_id = $_REQUEST['device']; ?>
	<script type="text/javascript">
		$(document).live( "pagecreate", function() {
				...
				$("#distance_report_live").mobipick();
				$("#distance_report_live1").mobipick();
				$("#distance_report_live").bind( "change", function() {
					var date = $( this ).val();
					var dateObject = $( this ).mobipick( "option", "date" );
				});	
				$("#distance_report_live1").bind( "change", function() {
					var date = $( this ).val();
					var dateObject = $( this ).mobipick( "option", "date" );
				});	
		});
				...
				<table style='width:100%;'>
					<tr  align='center'>
						<td  align='right'><?php echo $lang['From Date']; ?>:</td>
  	                	<td><input type="text" name="date" id="distance_report_live"   /></td>
					</tr>
					<tr  align='center'>
						<td  align='right'><?php echo $lang['To Date']; ?>:</td>
  	                	<td><input type="text" name="date1" id="distance_report_live1"   /></td>
					</tr>
					<?php 
						$user = $_SESSION['user_id'];
