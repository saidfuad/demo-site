	...
	*/$device_Array = array();
	...
	for($i=0;$i<count($device);$i++)
	{
		...
		while($rowest =mysql_fetch_array($results)){
			...
			$device_Array['image_type'][$device_id] = $rowest['image_type'];
			...
			/* if($device_Array['assets_category_id'][$device_id] == 1 || $device_Array['assets_category_id'][$device_id] == "" || $device_Array['assets_category_id'][$device_id] == 0 || $device_Array['assets_category_id'][$device_id] == 13){
				$device_Array['image_type'][$device_id] = "truck.png";
			}else if($device_Array['assets_category_id'][$device_id] == 2){
				$device_Array['image_type'][$device_id] = "car.png";
			}
			...
			else if($device_Array['assets_category_id'][$device_id] == 4){
				$device_Array['image_type'][$device_id] = "mobile.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 5){
				$device_Array['image_type'][$device_id] = "bike.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 6){
				$device_Array['image_type'][$device_id] = "altenator.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 7 || $device_Array['assets_category_id'][$device_id] == 8){
				$device_Array['image_type'][$device_id] = "man.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 9){
				$device_Array['image_type'][$device_id] = "stacker.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 10){
				$device_Array['image_type'][$device_id] = "loader.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 11){
				$device_Array['image_type'][$device_id] = "locomotive.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 12){
				$device_Array['image_type'][$device_id] = "generator.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 13){
				$device_Array['image_type'][$device_id] = "maintenance.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 14){
				$device_Array['image_type'][$device_id] = "motor.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 15){
				$device_Array['image_type'][$device_id] = "bobcat.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 16){
				$device_Array['image_type'][$device_id] = "tractor.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 17){
				$device_Array['image_type'][$device_id] = "car1.png";
			}
			else if($device_Array['assets_category_id'][$device_id] == 18){
				$device_Array['image_type'][$device_id] = "satellite.png";
			}
			else{
				$device_Array['image_type'][$device_id] = "truck.png";
			}
...
$(document).ready(function(){
	...
	aprox_height=Number(height-120)+"px";
