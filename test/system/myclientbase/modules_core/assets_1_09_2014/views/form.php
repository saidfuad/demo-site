  ...
  <input type="hidden" name="last_group" id="last_group" value="<?php echo $this->form_model->last_group; ?>" />
    ...
    <table width="100%" align="center" class="formtable">
      <tbody>
		...
		<tr rowspan="2">
			<td  style="color:fff;"><label><?php echo $this->lang->line("Users"); ?>:</label>
                <select multiple="multiple" size="10" name="asset_users_id[]" id="asset_users_id" class="select ui-widget-content ui-corner-all">
