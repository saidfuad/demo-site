...
class Import_Locations extends Admin_Controller {
	...
	function __construct() {
		...
		$this->load->model('import_landmarks_model','',TRUE);
		$this->load->model('form_model','',TRUE);
	}
	function index()
	{
		$this->load->view('import_landmarks');
	}
	function loadData(){
	...
	function deleteData(){
		...
		$this->output->set_output($this->import_landmarks_model->delete_data());
	}
	...
	{	
		...
		$colModel['name'] = array('Landmark Name',150,TRUE,'center',1);
		$colModel['device_ids'] = array('Devices',100,TRUE,'center',1);
		$colModel['radius'] = array('Radius',100,TRUE,'center',1);
		$colModel['latitude'] = array('Latitude',100,TRUE,'center',1);
		$colModel['longitude'] = array('Longitude',100,TRUE,'center',1);
