			...
			<table width="100%" align="center" class="formtable">
				<tbody>
					<tr>
						...
						<td width="50%"><label>Charges(Per Day) *</label><input type="text" name="charges_per_day" id="charges_per_day" class="text ui-widget-content ui-corner-all" value="<?php echo $this->form_model->charges_per_day; ?>" /></td>
					...
					<Tr>
						...
						<td colspan="2">
							...
							else
							{
								...
								$pres = $this->db->query("select concat(menu_id) from  mst_user_profile_setting where del_date is null and status=1 and setting_name='main' and profile_id=".$pid);
