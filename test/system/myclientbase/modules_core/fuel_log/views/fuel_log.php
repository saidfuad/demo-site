...
#ui_tpicker_hour_label_fuel_sdate,#ui_tpicker_hour_label_fuel_edate
{
...
#ui_tpicker_minute_label_fuel_sdate,#ui_tpicker_minute_label_fuel_edate
{
padding: 0px !important;
margin-top: 4px !important;
text-align: left !important;
...
#ui_tpicker_second_label_fuel_sdate,#ui_tpicker_second_label_fuels_edate
{
padding: 0px !important;
margin-top: 4px !important;
text-align: left !important;
...
jQuery().ready(function (){
	...
	jQuery("#stopreport_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>",'<?php echo $this->lang->line("Asset_Name"); ?>','<?php echo $this->lang->line("Datetime"); ?>','Fuel Reading', 'Fuel Percentage', 'Fuel Liters'],
		...
		colModel:[
			...
			{name:"fuel_reading",editable:true, hidden:true, index:"fuel_reading", width:300, align:"center", jsonmap:"fuel_reading"},
...
<table width="100%" class="formtable" style="margin-bottom: 5px;">
	<tr>
		...
		<!--td width="20%"><?php echo $this->lang->line("Status"); ?> : <select name="fuel_status" id="fuel_status" class="select ui-widget-content ui-corner-all" style="width:70% !important"><option value=''>All</option><option value='1'>Fuel Filled</option></select></td-->
