...
<div id="car<?php echo $prefix; ?>" style="color: white; background-image:url(<?php echo base_url(); ?>assets/<?php echo $image_type; ?>); font-family: 'Lucida Grande', 'Arial', sans-serif;font-size: 10px;text-align: center; width: 35px; height:35px; white-space: nowrap;margin-top:-20px;">
</div>
</div>
</div>
<script type="text/javascript">
