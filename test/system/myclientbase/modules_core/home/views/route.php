...
<div class="realContent" style=" position:absolute; top:55px;">
  ...
  <div id="dialog_route<?php echo time(); ?>" style="dispaly:none;">
		...
		<table>
			<tr>
				<td colspan="2">
					<select id="location<?php echo time(); ?>" style="width:400px;height:200px">
						<?php echo $landOpt; ?>
					</select>&nbsp;&nbsp;
		...
		<input type="button" onclick="GetDirections()" value="<?php echo $this->lang->line("Get_directions"); ?>"/>&nbsp;<input id="saveBtn" style="display:none" type="button" onclick="open_dialog()" value="<?php echo $this->lang->line("Save"); ?>"/><br/>
  ...
  <div id="dialog_save_route<?php echo time(); ?>" style="dispaly:none;">
		...
		<input type="button" onclick="saveRoute()" value="<?php echo $this->lang->line("Save Route"); ?>"/><br/>
  </div>
  <div id="directions">
  </div>
...
$(document).ready(function () {
	...
	$("#dialog_route<?php echo time(); ?>").dialog({
		...
		height: 300,
		position:['right',175],
		title:'<?php echo $this->lang->line("Create Route"); ?>'
	});
