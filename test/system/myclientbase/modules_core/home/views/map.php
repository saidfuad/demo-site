...
*/				
	...
	?>	
		...
		if(<?php echo $location_with_tag; ?> == 1){
			...
			*/
			...
			var boxText = "<div style='line-height: 15px; font-size: 11px; font-weight: bold; color: #2E6E9E; border: 1px solid black; background: none repeat scroll 0% 0% #DFEFFC; padding: 4px; margin: 0px 0px 0px 50px; text-align:center; -moz-border-radius: 8px; border-radius: 8px; white-space: nowrap;'><img src='<?php echo base_url(); ?>assets/images/<?php echo $status_img; ?>' title='<?php echo $status; ?>'><img src='<?php echo base_url(); ?>assets/images/direction.jpg'>&nbsp;<?php echo addslashes($coord->assets_name )?></div>";
  ...
  <?php
	...
	?>		
                        var text = "<?php echo addcslashes($text,"\\\'\"\n\r"); ?>";		
			var point = new google.maps.LatLng(<?php echo floatval($landmark->lat); ?>, <?php echo floatval($landmark->lng); ?>);		
			
			map_landmark_array<?php echo time(); ?>.push(createLandmarkMarker<?php echo time(); ?>(map<?php echo time(); ?>, point, "<?php echo $landmark->name; ?>",text, '<?php echo $landmark->icon_path; ?>', '', "sidebar_map", '' ));
			...
			if(lat.length > 0){
				for(i=0; i<lat.length; i++){
					...
					if(location_with_tag == 1){
						...
						/*var boxText = "<div style='line-height: 15px; font-size: 11px; font-weight: bold; font-style: italic; color: white; border: 1px solid black; background: none repeat scroll 0% 0% #8467D7; padding: 2px; margin-top: 8px;text-align:center;-moz-border-radius: 8px; border-radius: 8px;'><img src='<?php echo base_url(); ?>assets/images/direction.jpg'>&nbsp;<img src='<?php echo base_url(); ?>assets/images/"+status_img+"' title='"+status[i]+"'>&nbsp;"+tag[i]+"</div>";
						*/
						var boxText = "<div style='line-height: 15px; font-size: 11px; font-weight: bold; color: #2E6E9E; border: 1px solid black; background: none repeat scroll 0% 0% #DFEFFC; padding: 2px; margin: 0px 0px 0px 50px; text-align:center; -moz-border-radius: 8px; border-radius: 8px; white-space: nowrap;'><img src='<?php echo base_url(); ?>assets/images/"+status_img+"' title='<?php echo $status; ?>'><img src='<?php echo base_url(); ?>assets/images/direction.jpg'>&nbsp;"+tag[i]+"</div>";
...
<div style='text-align: center;clear:both' id="refreshbar_id<?php echo $tme;?>">
	<div style="float:left;width:100%;height:2em;padding-top:0.2em"><input type='checkbox' onclick='stop_resume_toggle<?php echo $time;?>()' id='timer_toggle<?php echo $time; ?>' style='opacity:0;'> <?php //echo $this->lang->line('data_refresh_after'); ?> <input type='hidden' size='2' onblur='counter_change<?php echo $time; ?>()' value='30' id='time_in_seconds<?php echo $time; ?>'> <?php //echo $this->lang->line('seconds'); ?> <span style='display: inline-block;'><?php //echo $this->lang->line('refresh_after'); ?> <span style="visibility:hidden"  id='seconds<?php echo $time; ?>'>30</span> &nbsp;<?php //echo $this->lang->line('second'); ?></span> &nbsp;<span onClick="directRefreshMap()" style="font-weight:bold;text-decoration:underline;cursor:pointer"><?php //echo $this->lang->line('refresh'); ?></span></div>
