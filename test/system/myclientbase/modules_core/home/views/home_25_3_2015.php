...
<link rel="shortcut icon" href="<?php echo base_url(); ?>assets/dashboard/images/sai_electronics.png">
...
?>
    ...
    <div class="ui-layout-north" style="height:120px;">
		...
		<?php } else{ ?>
                    <img style="border: 2px #000;padding-top:0px" src='<?php echo base_url(); ?>assets/dashboard/images/<?php echo $this->session->userdata('user_logo'); ?>_logo.png'></img>
		<?php } ?> 
						...
						if($parent_menu_id[$i]==$parent_id)
						{
							...
							if($where_to_show[$i] == 'link'  and $parent_id == ""){
								if($tab_title[$i]!="About Us" && $tab_title[$i] != 'Home'){
									...
									echo " onclick='window.open(\"http://tecsoft.info/\");' ";
								} else {
									echo " onclick='window.open(\"http://tecsoft.info/\");' ";
...
<?php } ?>
	...
	<div class="ui-layout-south">
	<center>&copy; 2014 <?php echo $this->lang->line('wts'); ?> <a href="http://tecsoft.info/" target="_blank"><?php echo $this->lang->line('wts1'); ?></a><br></center>
	</div>
	<?php } ?>
