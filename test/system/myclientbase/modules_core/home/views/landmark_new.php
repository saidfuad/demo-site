...
<?php
  ...
  control_UI.title = '<?php echo $this->lang->line("click to Create Landmark"); ?>';
  ...
  areaText.innerHTML = '<?php echo $this->lang->line("Landmark"); ?>';
...
var htmltextLandmark = '<table class="formtable" id="poly_mainLandmark<?php echo time(); ?>" style="display:none">';
	...
	htmltextLandmark +=	'<tr>';
	htmltextLandmark +=	'<td><?php echo $this->lang->line("Landmark_Name");  ?></td>';
	...
	htmltextLandmark +=	'</tr>';
	htmltextLandmark +=	'<tr>';
	htmltextLandmark +=	'<td><?php echo $this->lang->line("Landmark_Color"); ?></td>';
...
/*	
	htmltextLandmark +=	'<tr>';
	htmltextLandmark +=	'<td style="vertical-align: middle !important;"><?php echo $this->lang->line("Area Type"); ?></td>';
...
*/	
	...
	htmltextLandmark +=	'</tr>';
	htmltextLandmark +=	'<tr>';
	htmltextLandmark +=	'<td style="line-height:25px;"><?php echo $this->lang->line("Step_1_:_Insert_Landmark_Name"); ?><br><?php echo $this->lang->line("Step_2_:_Select_devices_you_want_to_bind_with_this_landmark"); ?><br><?php echo $this->lang->line("Step_3_:_Click_on_Create"); ?><br><?php echo $this->lang->line("Step_4_:_Click_on_Map_And_Creat_Area_Minimun_Three_Point_Require"); ?><br><?php echo $this->lang->line("Step_5_:_Click_On_InseFrt_Button"); ?></td>';		
	htmltextLandmark +=	'</tr>';
	htmltextLandmark +=	'</table>';
...
function confirmDeleteLandmark(){
	...
	$.post("<?php echo base_url(); ?>index.php/home/deleteLandmark", { id: polyid },
	 function(data) {
...
function addLandmark<?php echo time(); ?>(){
	...
	if(polyname == "" || polyname == null){
		alert("<?php echo $this->lang->line("Please_Enter_Landmark_Name"); ?>");
		document.getElementById('txtPoly1<?php echo time(); ?>').focus();
		return false;
	}
	
	if(polyMarkersLandmark.length < 3){
		alert("<?php echo $this->lang->line("Please select landmark on map"); ?>");
		return false;
	}
...
function updateLandmark<?php echo time(); ?>(){
	...
	if(devId)
		...
		devId = '';
	var sUrl = "<?php echo base_url(); ?>index.php/home/updateLandmark";
...
<div id="area_size_div" style="display:none;"><p><?php echo $this->lang->line("Landmark_Size"); ?> : <span id="span-landmark"></span> mt&sup2;</p></div>
<?php  echo $onload; ?>
<script type="text/javascript">
