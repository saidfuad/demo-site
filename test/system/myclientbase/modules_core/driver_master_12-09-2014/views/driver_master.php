...
jQuery().ready(function (){
	...
	jQuery("#driver_master_grid").jqGrid({
		...
		datatype: "json",
		colNames:["<?php echo $this->lang->line("id"); ?>",'<?php echo $this->lang->line("Driver Name"); ?>','<?php echo $this->lang->line("Driver Code"); ?>','<?php echo $this->lang->line("Address"); ?>','<?php echo $this->lang->line("Mobile_No"); ?>','<?php echo $this->lang->line("email"); ?>'],
		colModel:[
...
<?php
	...
	if(in_array('Search',$data))
		...
		$Search = "false";	
	?>
	jQuery("#driver_master_grid").jqGrid("navGrid", "#driver_master_pager", {add:false, edit:false, del:<?php echo $delete; ?>, search:<?php echo $Search; ?>}, {}, {}, {}, {multipleSearch:false});
