...
var limit = 40;
var page = 1;
var url = "<?php echo base_url(); ?>index.php/tree/assets_list";
...
$(document).ready(function () {
	...
	$.ajax({
		async: false,
		url: "<?php echo base_url(); ?>index.php/tree/ajaxroot",
		success: function (data, status, xhr) {
			source = jQuery.parseJSON(data);
		}
	});

	tree.jqxTree({theme: 'ui-redmond', source: source, hasThreeStates: true, checkboxes: true });
...
/*		
		...
		$.each(children, function () {
			var item = tree.jqxTree('getItem', this);
			if(item.label != 'Loading...' ) tree.jqxTree('removeItem', item);
		});
*/		
	...
	<div class="ui-layout-center" id="tabs" style="float:left;position:relative;">
			...
			<div id="tabs-1">
				...
				<div class="sixteen columns" style="width:100%" >
                        ...
                        <div style="width:40%;float:left; font-size: 1em; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif;">
