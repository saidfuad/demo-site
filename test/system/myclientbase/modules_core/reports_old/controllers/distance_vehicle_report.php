...
class Distance_vehicle_report extends Admin_Controller {
	...
	function viewMap(){
		...
		$txtTop="";
		$txtTop .="<div style='background-color: lightgreen; text-align: center; border-radius: 7px 7px 7px 7px;'>Before ".ago($data['coords']['add_date'])." ago, Dt-".date("d.m.Y h:i a",strtotime($data['coords']['add_date']))."</div><span style='display: block ! important; width: 100%; height: 7px;'></span>";
		if(count($data2) > 0) {
