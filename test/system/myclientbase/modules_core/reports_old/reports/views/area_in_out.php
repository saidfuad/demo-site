...
<table width="100%" class="formtable">
	<tr>
		...
		<td width="14%"><?php echo $this->lang->line("Area"); ?> : <br><select name="area" id="area" class="select ui-widget-content ui-corner-all" ><?php echo $area; ?></select></td>
		<td width="14%"><?php echo $this->lang->line("Group"); ?> : <br><select onchange="filterAssetsCombo(this.value,'device_area')" name="group" id="group_device_area" class="select ui-widget-content ui-corner-all" ><?php echo $group; ?></select></td>
