...
jQuery().ready(function (){
	...
	$("#zone_in_out_pager option[value=10000]").text('<?php echo $this->lang->line("All"); ?>');
	...
	jQuery("#zone_in_out_grid").jqGrid("navButtonAdd","#zone_in_out_pager",{caption:"<?php echo $this->lang->line("Export"); ?>",
		onClickButton:function(){
			...
			var qrystr ="/export?sdate="+sdate+"&edate="+edate+"&group="+group+"&zone="+zone+"&device="+dev;
...
<table width="100%" class="formtable">
	<tr>
		...
		<td width="14%"><?php echo $this->lang->line("Zone"); ?> : <br><select name="zone" id="zone" class="select ui-widget-content ui-corner-all" ><?php echo $zone; ?></select></td>
		<td width="14%"><?php echo $this->lang->line("Group"); ?> : <br><select onchange="filterAssetsCombo(this.value,'device_zone')" name="group" id="group_device_zone" class="select ui-widget-content ui-corner-all" ><?php echo $group; ?></select></td>
