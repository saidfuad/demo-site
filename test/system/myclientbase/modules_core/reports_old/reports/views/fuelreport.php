...
jQuery().ready(function (){
	...
	jQuery("#fuelreport_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>",'<?php echo $this->lang->line("Asset_Name"); ?>','<?php echo $this->lang->line("Date"); ?>','<?php echo $this->lang->line("Start KM"); ?>','<?php echo $this->lang->line("End KM"); ?>','<?php echo $this->lang->line("Total Distance"); ?>','<?php echo $this->lang->line("Fuel"); ?>','<?php echo $this->lang->line("Mileage"); ?>'],
		colModel:[
		...
		multiselect: false, 
		sortorder: "desc",
		caption:"<?php echo $this->lang->line("Distance & Fuel Consumption Report"); ?>",
