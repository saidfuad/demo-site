...
jQuery().ready(function (){
	...
	jQuery("#distancereport_location_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>",'<?php echo $this->lang->line("date"); ?>','<?php echo $this->lang->line("Vehicle"); ?>', '<?php echo $this->lang->line("From"); ?>','<?php echo $this->lang->line("To"); ?>', '<?php echo $this->lang->line("Distance(KM)"); ?>'],
		colModel:[
	...
	$("#distancereport_location_pager option[value=10000]").text('<?php echo $this->lang->line("All"); ?>');
