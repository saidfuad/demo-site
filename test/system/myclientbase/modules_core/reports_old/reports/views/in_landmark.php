...
jQuery().ready(function (){
	...
	jQuery("#in_landmark_grid").jqGrid({
		...
		multiselect: false, 
		sortorder: "desc",
		caption:"<?php echo $this->lang->line("Vehicle In Landmark"); ?>",
...
<table width="100%" class="formtable" style="margin-bottom: 5px;">
	<tr>
		...
		<td width="15%"><?php echo $this->lang->line("End"); ?> : <input type="text" name="edate" id="in_landmark_edate" class="date text ui-widget-content ui-corner-all" style="width:160px" value="<?php echo date($date_format." ".$time_format); ?>" readonly="readonly"/></td><td width="20%" style="vertical-align:middle"><?php echo $this->lang->line("Landmark"); ?> : <select name="in_landmark_id" id="in_landmark_id" class="select ui-widget-content ui-corner-all" style="width:70% !important"><?php echo $landmark; ?></select></td>
