...
jQuery().ready(function (){
	...
	jQuery("#distancereport_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>",'<?php echo $this->lang->line("date"); ?>','<?php echo $this->lang->line("Distance_KM"); ?>', '<?php echo $this->lang->line("Device"); ?>','<?php echo $this->lang->line("running_time"); ?>'],
		colModel:[
...
//			{name:"run_time",editable:true, index:"run_time", width:100, align:"center", jsonmap:"run_time"}
	...
	$("#distancereport_pager option[value=10000]").text('<?php echo $this->lang->line("All"); ?>');
...
<table width="100%" class="formtable" style="margin-bottom: 5px;">
	<tr>
		...
		<td width="14%"><?php echo $this->lang->line("Group"); ?> : <select onchange="filterAssetsCombo(this.value,'distancereportdevice')" style="width:120px;" name="group" id="group_distance_report" class="select ui-widget-content ui-corner-all" ><?php echo $group; ?></select></td>
