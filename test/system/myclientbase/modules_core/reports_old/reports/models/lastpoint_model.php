	...
	*/
	...
	//	echo $sub."<br/>".$srch."<br/>".$stsWhr;
		...
		if($cmd=="export") 
		{
			...
			$fitr.="<th>".$this->lang->line("Asset Name")."</th>";
			$fitr.="<th>".$this->lang->line("Address")."</th>";
			$fitr.="<th>".$this->lang->line("Speed(KM)")."</th>";
			$fitr.="<th>".$this->lang->line("Status")."</th>";
			$fitr.="<th>".$this->lang->line("Before Time")."</th>";
			$fitr.="<th>".$this->lang->line("In Area")."</th>";
			$fitr.="<th>".$this->lang->line("Near Landmark")."</th>";
			$fitr.="<th>".$this->lang->line("Battery Status")."</th>";
			$fitr.="<th>".$this->lang->line("Alarm Type")."</th>";
			$fitr.="<th>".$this->lang->line("Running Time")."</th>";
			$fitr.="<th>".$this->lang->line("Message Cause")."</th>";
			$fitr .="</tr>";
				...
				//	echo "<br/>befor->".$data['beforeTime'];
					if($minutes!="" || $minutes!=null)
					{
						if($minutes <= 20 && $data['speed'] > 0){
							$EXCEL.="<td>".$this->lang->line("Running")."</td>";
					//		echo "<br/>Running->".$minutes;
						}
						else if($minutes <= 20  && $data['speed'] == 0){
							$EXCEL.="<td>".$this->lang->line("Parked")."</td>";
					//		echo "<br/>Parked->".$minutes;
						}else if($minutes > 1440){
							$EXCEL.="<td>".$this->lang->line("Out of network")."</td>";
			...
			echo "<table border='1'>";
			echo "<tr><th colspan='7'> ".$this->lang->line("Last Points")."</th></tr>";
			echo $fitr;
			echo $EXCEL;
			echo "</table>";
			die(); 
