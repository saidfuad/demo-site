...
class Zone_in_out_model extends Model 
{
	...
	*/
	...
	function getAllData($cmd){
		...
		if($cmd=="export") 
		{
			...
			foreach($result->result_array() as $data)
				...
				echo "<table border='1'>";
				echo "<tr><th colspan='4'> Zone In Out</th></tr>";
	...
	{
		$query = $this->db->query("select * from landmark_areas where Audit_Status=1 AND Audit_Enter_uid = $user group by polyname asc");
		return $query->result();
		...
		*/
		...
		if($cmd=="export") 
		{
			...
			foreach($result->result_array() as $data)
				...
				echo "<table border='1'>";
				echo "<tr><th colspan='2'>Zone Report</th></tr>";
				echo $fitr;
				echo $EXCEL;
				echo "</table>";
				die(); 
