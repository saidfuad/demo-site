		...
		if(response.Speed.length > 0){
		  ...
		  var options = {
			 ...
			 highlighter: {
						...
						yvalues: 3,
						tooltipLocation:'n',
						formatString:'<table class="jqplot-highlighter"><tr><td><?php echo "<span>"."Double Click To Reset Map"."</span>";?></td></tr><tr><td align="left"><?php echo $this->lang->line("Time"); ?>:</td><td align="left"> &nbsp; %s</td></tr><tr><td align="left"><?php echo $this->lang->line("Speed"); ?>:</td><td align="left"> &nbsp; %s</td></tr><tr><td align="left"><?php echo $this->lang->line("Vehicle"); ?>:</td><td align="left"> &nbsp; %s</td></tr></table>'
				  }				 
				};
