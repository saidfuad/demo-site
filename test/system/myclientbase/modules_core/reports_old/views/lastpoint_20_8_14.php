...
jQuery().ready(function (){
	...
	jQuery("#lastpoint_grid").jqGrid({
		...
		colModel:[
			...
			{name:"km_reading",editable:true, index:"km_reading", width:90, align:"center", jsonmap:"km_reading"},
...
<?php  ?>
		...
		pager: $('#lastpoint_grid'),
		postData: {"report":report, "txt":txt}
		//scroll: true
	
	});
	/*$(window).bind('resize', function () {
    $("#lastpoint_grid").setGridWidth($("#lastpoint_grid").width());
    }).trigger('resize');*/
...
//	var minutes = Math.floor(rowObject.beforeTime/60);
	...
	if(rowObject.beforeTime=="" || rowObject.beforeTime==null)
		class_nm = "device_fault_asts";
	// alert('selectedAssets'+rowObject.assets_id);	
