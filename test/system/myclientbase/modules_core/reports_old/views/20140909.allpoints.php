...
function viewOnMapAllpointnew(){
	...
	var end_date = $('#end_date_context_menu').val();
...
<table border="5" width="100%" class="formtable" style="margin-bottom: 5px;">
	...
	<tr>
		<td width="15%"><?php echo $this->lang->line("Start"); ?> : <input type="text" name="sdate" id="all_points_sdate" class="date text ui-widget-content ui-corner-all" style="width:180px" value="" readonly="readonly"/></td>
		<td width="15%"><?php echo $this->lang->line("End"); ?> : <input type="text" name="edate" id="all_points_edate" class="date text ui-widget-content ui-corner-all" style="width:180px" value="" readonly="readonly"/></td>
