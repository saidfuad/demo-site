...
<table width="100%" class="formtable">
	<tr>
		...
		<td width="14%">Area : <br><select name="area" id="area_report" class="select ui-widget-content ui-corner-all" ><?php echo $area; ?></select></td>
		<td width="14%">Group : <br><select onchange="filterAssetsCombo(this.value,'device_area_report')" name="group" id="group_device_area_report" class="select ui-widget-content ui-corner-all" ><?php echo $group; ?></select></td>
