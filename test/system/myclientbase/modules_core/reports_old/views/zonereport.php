...
<table width="100%" class="formtable">
	<tr>
		...
		<td width="14%">Zone : <br><select name="zone" id="zone_report" class="select ui-widget-content ui-corner-all" ><?php echo $zone; ?></select></td>
		<td width="14%">Group : <br><select onchange="filterAssetsCombo(this.value,'device_zone_report')" name="group" id="group_device_zone_report" class="select ui-widget-content ui-corner-all" ><?php echo $group; ?></select></td>
