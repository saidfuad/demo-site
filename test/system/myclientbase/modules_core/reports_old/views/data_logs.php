...
jQuery().ready(function (){
	...
	jQuery("#data_logs_grid").jqGrid({
		...
		datatype: "json",
		//,'Device ID'
		colNames:["<?php echo $this->lang->line("ID"); ?>", 'Datetime','Raw Data'],
		colModel:[
...
<form onsubmit="return searchdata_logs()">
	...
	<tr>
		...
		<td width="20%">Group : <select
		onchange="AllPointfilterAssetsCombolog(this.value,'data_logs_device')"
		name="group" id="group_device_logs" class="select ui-widget-content ui-corner-all" style="width:200px"><?php echo $group1; ?></select></td>
		<td width="20%"><?php echo $this->lang->line("Assets"); ?> : <select name="device_1" id="data_logs_device" class="select ui-widget-content ui-corner-all" style="width:200px"><?php echo $devices; ?></select></td>
	</tr>
	<tr>
