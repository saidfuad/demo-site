...
jQuery().ready(function (){ 
	...
	jQuery("#tooltip_grid").jqGrid({
		...
		colModel:[ 
			...
			{name:"link",editable:true, index:"link", width:50, align:"center", jsonmap:"link", formatter:formatStage_Report, search:false},
...
<table width="100%">
	<tr>
		<td width="20%"><?php echo $this->lang->line("Start"); ?> : <input type="text" name="tootip_sdate" id="tootip_sdate" class="date text ui-widget-content ui-corner-all" style="margin-top: 5px;padding: 0.4em;width: 54%;" value="<?php echo date('1.m.Y'); ?>" readonly="readonly"/></td>
		<td width="20%"><?php echo $this->lang->line("End"); ?> : <input type="text" name="tootip_edate" id="tootip_edate" class="date text ui-widget-content ui-corner-all" style="margin-top: 5px;padding: 0.4em;width: 54%;" value="<?php echo date('d.m.Y'); ?>" readonly="readonly"/></td>
