	...
	$('#tabs').tabs({
		...
		select: function (e,ui) {
			if(ui.panel.id=="tabs-1")
			{
				...
				$("#west_sub_menu #opt_users").val(sel_users);
				$("#west_sub_menu #opt_groups").val(sel_groups);
				$("#west_sub_menu #opt_areas").val(sel_areas);
				$("#west_sub_menu #opt_landmarks").val(sel_landmarks);
				$("#west_sub_menu #opt_owners").val(sel_owners);
				$("#west_sub_menu #opt_divisions").val(sel_divisions);
			}
			/*else
			{
				$("#float-icons").hide();
...
//	//$("#loading_dialog").dialog("open");
	...
	//myLayout.close( "west" );
	//loadEaxtraJs();
	$(".ui-layout-west").html($('#home_sidebar').html());
...
?>
					...
					<div style="float:left;">
                        ...
                        <div style="width:40%;float:left; font-size: 1em; font-family: Lucida Grande,Lucida Sans,Arial,sans-serif;">
							<table width="100%" cellspacing="3" cellpadding="5" style="margin: 0px 5px;">
								<tr>
								<td width="25%">Users<br><select id="opt_users" style="width: 100px; border: 1px solid #CCCCCC; border-radius: 2px; color:#444444; padding:6px 4px;" onChange="changeReport(); setcombo('opt_users', this.value);"><option value=''>All Users</option><?php echo $subUserOpt; ?></select></td>
								<td width="15%">Groups<br><select id="opt_groups" style="border: 1px solid #CCCCCC; border-radius: 2px; color:#444444; padding:6px 4px;" onChange="changeReport(); setcombo('opt_groups', this.value);"><option value=''>All Group</option><?php echo $groupOpt; ?></select></td>
								<td width="15%">Areas<br/><select id="opt_areas" style="width: 100px; border: 1px solid #CCCCCC; border-radius: 2px; color:#444444; padding:6px 4px;" onChange="changeReport(); setcombo('opt_areas', this.value);"><option value=''>All Areas</option><?php echo $areasOpt; ?></select></td>
								<td width="15%">Landmarks<br/><select id="opt_landmarks" style="width: 100px; border: 1px solid #CCCCCC; border-radius: 2px; color:#444444; padding:6px 4px;" onChange="changeReport(); setcombo('opt_landmarks', this.value);"><option value=''>All Landmarks</option><?php echo $landOpt; ?></select></td>
				                <td width="15%">Owners<br/><select id="opt_owners" style="width: 100px; border: 1px solid #CCCCCC; border-radius: 2px; color:#444444; padding:6px 4px;" onChange="changeReport(); setcombo('opt_owners', this.value);"><option value=''>All Owner</option><?php echo $ownerOpt; ?></select></td>
				                <td width="15%">Divsions<br/><select id="opt_divisions" style="width: 100px; border: 1px solid #CCCCCC; border-radius: 2px; color:#444444; padding:6px 4px;" onChange="changeReport(); setcombo('opt_divisions', this.value);"><option value=''>All Division</option><?php echo $divisionOpt; ?></select></td>
								</tr>
							</table>
                        </div>
		                <?php } ?>
	...
	<div class="ui-layout-west" id="west_sub_menu"></div>
        <div id='home_sidebar' class="submenu" style="display:none"> 
            <?php /* if($this->session->userdata('show_dash_assets_combo') != 0){ ?>
                ...
                <label style="margin-left:10%;" for="users">Ownwers</label><br />
