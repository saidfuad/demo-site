...
<?php if('test.trackeron.com' == $_SERVER['HTTP_HOST'] || 'vts.trackeron.com' == $_SERVER['HTTP_HOST'] || 'gogpslive.com' == $_SERVER['HTTP_HOST']){ ?>
					...
					for($i=0;$i<count($menu_id);$i++)
					{
						if($parent_menu_id[$i]==$parent_id)
						{
							...
							if($where_to_show[$i] == 'link'  and $parent_id == ""){
								...
								}else if('test.trackeron.com' == $_SERVER['HTTP_HOST'] || 'vts.trackeron.com' == $_SERVER['HTTP_HOST'] || 'gogpslive.com' == $_SERVER['HTTP_HOST']){
									echo " onclick='window.open(\"http://cadsite.com.au/\");' ";
								} else {
