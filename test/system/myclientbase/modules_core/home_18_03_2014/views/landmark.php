...
var htmltext_landmark = '<table class="formtable" id="land_main<?php echo time(); ?>" style="display:none;">';
	...
	htmltext_landmark +=	'<td style="vertical-align: middle !important;"><span><?php echo $this->lang->line("group_name"); ?>:<span><a href="#" style="float:right;margin-right:15px;color:blue;font-size:10px" onclick="selectAlllandmark<?php echo time(); ?>(\'<?php echo "#land_device_".time(); ?>\')"><?php echo $this->lang->line("Select/Unselect All"); ?></a></span> </span>';
