...
class Asset_category_model extends Model 
{
	...
	*/
	...
	function asset_cat1()
	{
	$uploadedimage=$db_array['assets_cat_image1'];
            $date=date("Y-m-d H:i:s");
	    $status=1;
        if($uploadedimage != ''){
$db_array['assets_cat_image']=$uploadedimage;
$sql="insert into assests_category_images (image_path,add_uid,add_date,status) values('$uploadedimage','$user','$date','$status')";
$query1=$this->db->query($sql);
//$this->db->insert("assests_category_images", $db_array['assets_cat_image']);
...
//$this->db->insert("assests_category_images", $db_array['assets_cat_image']);
		...
		unset($db_array['assets_cat_image1']);
...
//$this->db->insert("assests_category_images", $db_array['assets_cat_image']);
		...
		unset($db_array['assets_cat_image1']);
		$this->db->update("assests_category_master", $db_array);
		$this->db->where("id", $id);
		//$insert_id = $this->db->insert_id();
