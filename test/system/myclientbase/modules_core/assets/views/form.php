...
<script type="text/javascript">
	$(document).ready(function() {
      ...
      $("#driver_id").change(function(){	
         	  var id=$( "#driver_id option:selected" ).text();
		$.post("<?php echo base_url(); ?>index.php/assets/driver_mobile/id/"+id,function(data){
			$('#driver_mobile').val(data);
			});
		});
		//end
    ...
    <table width="100%" align="center" class="formtable">
      <tbody>
        ...
        <tr>
          ...
          <!--Added by Poonam 24-01-2015 12:30 PM(only Assets Type added) -->
		...
		<tr>
			<td  style="color:fff;" rowspan="2"><label><?php echo $this->lang->line("Map Users"); ?></label>
                <select multiple="multiple" size="5" name="asset_users_id[]" id="asset_users_id" class="select ui-widget-content ui-corner-all">
                    <?php echo $this->form_model->asset_users_id; ?>
                </select>
            </td>
                        <!--Added by Poonam 24-01-2015 12:30 PM(only Assets Category added) -->
        ...
        <tr>
         <!-- <td><label><?php //echo $this->lang->line('Driver_Name'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
          ...
          <td>-->
		  <td><label><?php echo $this->lang->line('Driver_Name');?>:</label>
            <select name="driver_name" id="driver_id" class="select ui-widget-content ui-corner-all">
              <option value=''><?php echo $this->lang->line("Please Select"); ?></option>
		<?php echo $this->form_model->driver_name; ?>
            </select>
			</td>
<td>
       ...
       <tr>
        ...
        <tr>
		   ...
		   <tr>
			<td><label><?php echo $this->lang->line('Assets Division'); ?></label>
			...
			<td><label><?php echo $this->lang->line('Assets Owner'); ?></label>
            <select name="assets_owner" id="assets_owner" class="select ui-widget-content ui-corner-all">
            <?php echo $this->form_model->ownersOpt; ?>
            </select></td>
