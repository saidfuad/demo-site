    ...
    <table width="100%" align="center" class="formtable">
      <tbody>
        <tr>
          ...
          <td><label><?php echo $this->lang->line('Assets_Image'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
		...
		<td width="50%"><label><?php echo $this->lang->line('Device'); ?>:</label>
            <input type="text" name="device_id" id="device_id" class="text ui-widget-content ui-corner-all" value="<?php echo $this->form_model->device_id; ?>"/></td>
		<td width="50%"><label><?php echo $this->lang->line('assets_friendly_nm'); ?>:</label>
            <input type="text" name="assets_friendly_nm" id="assets_friendly_nm" class="text ui-widget-content ui-corner-all" value="<?php echo $this->form_model->assets_friendly_nm; ?>"/></td>
		</tr>
        <tr>
          <td><label><?php echo $this->lang->line('Icon'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
		  <br/><img src="<?php echo "<?php echo base_url(); ?>/assets/marker-images/".$this->form_model->iconPath; ?>" id="ic_path_id" title="<?php echo $this->form_model->iconName; ?>" style='margin-right:5px;'/><input type="button" id="getIconList" value="Choose Icon"/>
        ...
        <tr>
          <td><label><?php echo $this->lang->line('Assets_Type'); ?></label>
           ...
           <!-- <input type="file" name="assets_image_path" id="assets_image_path" class="text ui-widget-content ui-corner-all" value="<?php echo $this->form_model->assets_image_path; ?>"/> --></td>
       ...
       <tr>
		 ...
		 <td><label><?php echo $this->lang->line('Max_speed_limit'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
          ...
          <td><label><?php echo $this->lang->line('Maximum_Fual_Capacity'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
		...
		<tr>
		 ...
		 <td><label><?php echo $this->lang->line('Max_fual_liters'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
