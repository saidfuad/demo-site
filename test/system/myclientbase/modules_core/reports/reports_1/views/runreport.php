...
jQuery().ready(function (){
	...
	jQuery("#runreport_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>", '<?php echo $this->lang->line("Device"); ?>','<?php echo $this->lang->line("Start_Time"); ?>','<?php echo $this->lang->line("Stop_Time"); ?>', '<?php echo $this->lang->line("Start Odo"); ?>.', '<?php echo $this->lang->line("Stop Odo"); ?>.', '<?php echo $this->lang->line("running_time"); ?>', '<?php echo $this->lang->line("Distance_KM"); ?>'],
		colModel:[
	 ...
	 function(data) {
		if(data){
			...
			if(lat.length > 0){
				...
				var txt = devText + " <?php echo $this->lang->line("Distance"); ?> : " + distance + " <?php echo $this->lang->line("KM"); ?>";
...
<table width="100%" class="formtable" style="margin-bottom: 5px;">
	<tr>
		...
		<td width="14%"><?php echo $this->lang->line("Group"); ?> : <select onchange="filterAssetsCombo(this.value,'runreportdevice')" style="width:120px;" name="group" id="group_run_report" class="select ui-widget-content ui-corner-all" ><?php echo $group; ?></select></td>
