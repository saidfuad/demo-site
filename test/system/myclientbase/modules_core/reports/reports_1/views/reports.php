...
function TrackControl(controlDiv, mapmap) {
  ...
  controlUI.title = '<?php echo $this->lang->line("Click to start or stop Tracking"); ?>';
  ...
  controlText.innerHTML = '<?php echo $this->lang->line("Start"); ?>';
...
<div id="myTextDiv" style="color: white; position: absolute;">
    <h1><?php echo $this->lang->line("Hello World"); ?></h1>
</div>
