...
jQuery().ready(function (){
	...
	jQuery("#lastpoint_grid").jqGrid({
		...
		datatype: "json",
		colNames:["<?php echo $this->lang->line("ID"); ?>", '', '', '<?php echo $this->lang->line("Asset_Name"); ?>','<?php echo $this->lang->line("Device ID"); ?>', '<?php echo $this->lang->line("Friendly Name"); ?>', '<?php echo $this->lang->line("AST_ID"); ?>', '<?php echo $this->lang->line("Dev Status"); ?>', '<?php echo $this->lang->line("Img"); ?>', '<?php echo $this->lang->line("Direction"); ?>', '<?php echo $this->lang->line("Datetime"); ?>', '<?php echo $this->lang->line("Address"); ?>', '<?php echo $this->lang->line("Latitude"); ?>', '<?php echo $this->lang->line("Longitude"); ?>', '<?php echo $this->lang->line("MImage"); ?>', '<?php echo $this->lang->line("MText"); ?>', '<?php echo $this->lang->line("Speed_KM"); ?>', '<?php echo $this->lang->line("Mileage (KM)"); ?>', '<?php echo $this->lang->line("Run Time"); ?>', '<?php echo $this->lang->line("Ignition"); ?>', '<?php echo $this->lang->line("Parked From"); ?>', '<?php echo $this->lang->line("Status"); ?>', '<?php echo $this->lang->line("Before"); ?>','<?php echo $this->lang->line("Before"); ?>', '<?php echo $this->lang->line("Zone"); ?>', '<?php echo $this->lang->line("In_Area"); ?>', '<?php echo $this->lang->line("Near Landmark"); ?>', '<?php echo $this->lang->line("Battery Status"); ?>', '<?php echo $this->lang->line("alarm_type"); ?>', '<?php echo $this->lang->line("assets_division"); ?>', '<?php echo $this->lang->line("assets_owner"); ?>', '<?php echo $this->lang->line("message_cause"); ?>', '<?php echo $this->lang->line("Speed Limit Cross"); ?>'],
		colModel:[
...
//	var minutes = Math.floor(cellValue/60);
	...
	if(minutes < <?php echo $network_timeout; ?> && rowObject.speed > 10){
		vehicleStatus = "<?php echo $this->lang->line("Running"); ?>";
	}
	else if(minutes < <?php echo $network_timeout; ?> && rowObject.speed <= 10 && rowObject.ignition == 0){
		vehicleStatus = "<?php echo $this->lang->line("Parked"); ?>";
	}else if(minutes < <?php echo $network_timeout; ?> && rowObject.speed <= 10 && rowObject.ignition == 1){
		vehicleStatus = "<?php echo $this->lang->line("Idle"); ?>";
	}else if(minutes > <?php echo $network_timeout; ?> && minutes < <?php echo ($network_timeout+36000); ?>){
		vehicleStatus = "<?php echo $this->lang->line("Out of network"); ?>";
	}else{
		vehicleStatus = "<?php echo $this->lang->line("Out of network"); ?>";
	}
...
function format_map(cellVal, options, rowObject){
	var html="<?php echo $this->lang->line("Date"); ?> : "+rowObject.add_date+"<br><?php echo $this->lang->line("Speed"); ?> : "+rowObject.speed+"<br><?php echo $this->lang->line("Address"); ?> : "+rowObject.address+"<br>";
