...
{
	//alert(device_id);
	var nameToCheck = assetNameArray[device_id]+" <?php echo $this->lang->line("Details"); ?>";
	var tabNameExists = false;
		...
		if (!tabNameExists){
			...
			{
				$('#tabs').tabs('add', "<?php echo base_url(); ?>index.php/home/assets_dash/id/"+device_id, assetNameArray[device_id]+" <?php echo $this->lang->line("Details"); ?>");
			}
...
function onLoadmap<?php echo time(); ?>() {
	...
	myTextDiv_top_left.innerHTML = '<h2 style="color:black;background-color:rgba(255,255,255,0.7);padding:3px">&nbsp;<?php echo $coords['distance'].$this->lang->line("KM"); ?>&nbsp;</h2>';
  ...
  <?php
	...
	if(count($landmarks) > 0) {
		foreach ($landmarks as $landmark) {
			...
			$text = $this->lang->line("Name")." : ".$landmark->name."<br>";
			$text .= $this->lang->line("Address")." : ".$landmark->address."<br>";
			$text .= $this->lang->line("Assets")." : ".$landmark->assets.'<br>';
