	...
	*/
	...
	function getAllData($cmd){
		...
		if($cmd=="export") 
		{
			...
			$fitr .="<tr>"; 
			$fitr.="<th>".$this->lang->line("Person")."</th>";
			$fitr.="<th>".$this->lang->line("Boarding Assets")."</th>";
			$fitr.="<th>".$this->lang->line("Boarding Time")."</th>";
			$fitr.="<th>".$this->lang->line("Address")."</th>";
			$fitr.="<th>".$this->lang->line("Leaving Assets")."</th>";
			$fitr.="<th>".$this->lang->line("Leaving Time")."</th>";
			$fitr.="<th>".$this->lang->line("Address")."</th>";
			$fitr .="</tr>"; 
			...
			echo "<table border='1'>";
			echo "<tr><th colspan='7'>".$this->lang->line("RFID Log")."</th></tr>";
			echo "<tr><th colspan='1'>".$this->lang->line("Start Date")."</th><th colspan='1'>".$this->lang->line("End Date")."</th><th colspan='5'>".$this->lang->line("Assets Name")."</th></tr>";
