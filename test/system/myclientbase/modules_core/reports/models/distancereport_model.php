	...
	*/
	...
	//	$cmd=uri_assoc('cmd');
		...
		*/
		...
		$SQL = "SELECT dm.id,CONCAT(am.assets_name,'(',am.device_id,')') as assets_id, am.id as aId, dm.add_date, dm.distance from distance_master dm left join assests_master am on am.id=dm.assets_id WHERE ";
	...
	public function get_distancegraph() 
	{
		...
		*/
		...
		$qryFinal ="SELECT dm.fuel_used, dm.id, dm.assets_id as assets_id, am.assets_name as devices, am.fuel_in_out_sensor,  dm.add_date, dm.distance as distance from distance_master dm left join assests_master am on am.id=dm.assets_id";
