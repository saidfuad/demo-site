...
jQuery().ready(function (){
	...
	jQuery("#stopreport_ignitionOff").jqGrid({
		url:"<?php echo base_url(); ?>index.php/reports/stopreport_ignitionOff/loadData",
		datatype: "local",
		...
		multiselect: false, 
		sortorder: "desc",
		caption:"<?php echo $this->lang->line("Ignition off Stop Report "); ?>",
		editurl:"users/deleteData",
		jsonReader: { repeatitems : false, id: "0" }
	});

	jQuery("#stopreport_ignitionOff").jqGrid("navGrid", "#stopreport_pager", {add:false, edit:false, del:false, search:false}, {}, {}, {}, {multipleSearch:false});
	...
	?>
	jQuery("#stopreport_ignitionOff").jqGrid("navButtonAdd","#stopreport_pager",{caption:"<?php echo $this->lang->line("Export"); ?>",
...
<table id="stopreport_ignitionOff_grid" class="jqgrid"></table>
