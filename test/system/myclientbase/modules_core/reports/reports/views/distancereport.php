...
jQuery().ready(function (){
	...
	jQuery("#distancereport_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>",'<?php echo $this->lang->line("date"); ?>','<?php echo $this->lang->line("Distance_KM"); ?>', '<?php echo $this->lang->line("Device"); ?>','<?php echo $this->lang->line("Running Time"); ?>'],
		colModel:[
