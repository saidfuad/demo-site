		...
		if(response.Speed.length > 0){
		  ...
		  var options = {
			 ...
			 axesDefaults: {			
			  ...
			  axes: {
				  yaxis: { min:0, max: 140, 
						label: '<?php echo $this->lang->line("Speed"); ?>',
			 ...
			 highlighter: {
						...
						yvalues: 3,
						tooltipLocation:'n',
						formatString:'<table class="jqplot-highlighter"><tr><td><?php echo "<span>".$this->lang->line("Double Click To Reset Map")."</span>";?></td></tr><tr><td align="left"><?php echo $this->lang->line("Time"); ?>:</td><td align="left"> &nbsp; %s</td></tr><tr><td align="left"><?php echo $this->lang->line("Speed"); ?>:</td><td align="left"> &nbsp; %s</td></tr><tr><td align="left"><?php echo $this->lang->line("Vehicle"); ?>:</td><td align="left"> &nbsp; %s</td></tr></table>'
				  }				 
				};
...
$(document).ready(function() {	
	...
	//$("#speedgraph_etime").timepicker('setDate', new Date('<?php echo date("Y/m/d H:i:s"); ?>'));
        ...
        $("#speedgraph_stime").timepicker('setDate', new Date('<?php echo date("Y/m/d H:i:s",strtotime("12:00:00 am")); ?>'));
	$("#speedgraph_etime").timepicker('setDate', new Date('<?php echo date("Y/m/d H:i:s",strtotime("11:59:59 pm")); ?>'));
...
<div style="height:100px;">
  ...
  <div style="margin-left:10px;">
    <table width="100%" class="formtable" style="margin-bottom: 5px;">
      <tr>
        <td align='left'><?php echo $this->lang->line("date"); ?> </td>
		<td align='left'><?php echo $this->lang->line("Start_Time"); ?> </td>
		<td align='left'><?php echo $this->lang->line("End_Time"); ?> </td>
		<td align='left'><?php echo $this->lang->line("Assets"); ?> </td>
		<td align='left'>&nbsp;</td>
	</tr>
	<tr>
	<td align='left'><input type="text" name="sg_date" id="speedgraph_date" class="date text ui-widget-content ui-corner-all" style="width:110px" value="<?php echo date($date_format); ?>" readonly="readonly"/></td>
        <td align='left'><input type="text" name="sg_stime" id="speedgraph_stime" class="timepicker text ui-widget-content ui-corner-all" style="width:80px" readonly="readonly" value="<?php echo date($time_format); ?>"/></td>
        <td align='left'><input type="text" name="sg_etime" id="speedgraph_etime" class="timepicker text ui-widget-content ui-corner-all" value="<?php echo date($time_format); ?>" style="width:80px" readonly="readonly"/></td>
   		<td align='left'>
		
          <select style="width:130px;" name="sg_device" id="speedgraph_device" class="select ui-widget-content ui-corner-all" multiple='multiple'></select>
          </select></td>
        <td align='left'><input type="submit" value="<?php echo $this->lang->line("view"); ?>"/></td>
	  </tr>
    </table>
	</div>
  </form>
