...
<table width="100%" class="formtable">
	<tr>
		...
		<td width="14%"> <?php echo $this->lang->line("Zone"); ?> : <br><select name="zone" id="zone" class="select ui-widget-content ui-corner-all" ><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $zone; ?></select></td>
		<td width="14%"> <?php echo $this->lang->line("Group"); ?> : <br><select onchange="filterAssetsCombo(this.value,'device_zone')" name="group" id="group_device_zone" class="select ui-widget-content ui-corner-all" ><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $group; ?></select></td>
