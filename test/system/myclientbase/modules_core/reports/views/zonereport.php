...
jQuery().ready(function (){
	...
	$("#zone_report_pager option[value=10000]").text('All');
	...
	jQuery("#zone_report_grid").jqGrid("navButtonAdd","#zone_report_pager",{caption:"<?php echo $this->lang->line("Export"); ?>",
		onClickButton:function(){
			...
			var myPostData = $('#zone_report_grid').jqGrid("getGridParam", "postData");
...
<table width="100%" class="formtable">
	<tr>
		...
		<td width="14%"><?php echo $this->lang->line("Zone"); ?> : <br><select name="zone" id="zone_report" class="select ui-widget-content ui-corner-all" ><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $zone; ?></select></td>
		<td width="14%"> <?php echo $this->lang->line("Group"); ?> : <br><select onchange="filterAssetsCombo(this.value,'device_zone_report')" name="group" id="group_device_zone_report" class="select ui-widget-content ui-corner-all" ><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $group; ?></select></td>
