...
jQuery().ready(function (){
	...
	jQuery("#allpoints_grid<?php echo time(); ?>").jqGrid("navButtonAdd","#allpoints_pager<?php echo time(); ?>",{caption:"Pdf",
		onClickButton:function(){
			...
			window.open("<?php echo site_url('reports/allpoints/export_pdf'); ?>"+qrystr,'_blank');
