...
<table border="5" width="100%" class="formtable" style="margin-bottom: 5px;">
	...
	<tr>
		...
		<td width="6%"><?php echo $this->lang->line("navigation_type"); ?>Navigation Type :</td><td width="10%"><select name="navigation_type" id="navigation_type" class="select ui-widget-content ui-corner-all"><option value="1">Point To Point</option</select><option value="2">Google Road</option></td>
