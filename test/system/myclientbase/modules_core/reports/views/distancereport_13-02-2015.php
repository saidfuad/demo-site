...
jQuery().ready(function (){
	...
	jQuery("#distancereport_grid").jqGrid({
		...
		datatype: "local",
		colNames:["<?php echo $this->lang->line("ID"); ?>","Asset Name","Distance in KM"],
		colModel:[
			...
			{name:"devices",editable:true, index:"devices", width:180, align:"center", jsonmap:"devices"},
			{name:"total_distance ",editable:true, index:"total_distance", width:100, align:"center", jsonmap:"total_distance"},
			//{name:"distance1",hidden:true, index:"distance1", width:100, align:"center", jsonmap:"distance1"}
