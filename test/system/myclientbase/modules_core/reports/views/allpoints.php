...
<table border="5" width="100%" class="formtable" style="margin-bottom: 5px;">
	...
	<tr>
		<td width="15%"><?php echo $this->lang->line("Start"); ?> :<br> <input type="text" name="sdate" id="all_points_sdate" class="date text ui-widget-content ui-corner-all" style="width:150px" value="" readonly="readonly"/></td>
		<td width="15%"><?php echo $this->lang->line("End"); ?> : <br><input type="text" name="edate" id="all_points_edate" class="date text ui-widget-content ui-corner-all" style="width:150px" value="" readonly="readonly"/></td>
		<td width="20%"><?php echo $this->lang->line("Navigation_Type"); ?> :<select name="navigation_type" id="navigation_type" class="select ui-widget-content ui-corner-all"><option value="1"><?php echo $this->lang->line("Point To Point"); ?></option</select><option value="2"><?php echo $this->lang->line("Google Road"); ?></option></td>
