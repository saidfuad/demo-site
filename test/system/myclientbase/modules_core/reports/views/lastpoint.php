...
jQuery().ready(function (){
 ...
 var window_width=$(window).width();
	...
	var data_query="";
	var all=5000;
	//removed the columns: Alarm type, asset division, asset owner, message cause, zone & change "before" to "Parked as of" This will shorten the length and may solve to issue
	jQuery("#lastpoint_grid").jqGrid({
		
		url:"<?php echo base_url(); ?>index.php/reports/lastpoint/loadData",
		datatype: "json",
		mtype: 'POST',		
		colNames:["<?php echo $this->lang->line("ID"); ?>", '', '', '<?php echo $this->lang->line("Asset_Name"); ?>','Device ID', 'Friendly Name', 'AST_ID', 'Dev Status', 'Img', 'Direction', '<?php echo $this->lang->line("Datetime"); ?>', '<?php echo $this->lang->line("Address"); ?>', 'Latitude', 'Longitude', 'MImage', 'MText', '<?php echo $this->lang->line("Speed_KM"); ?>', 'Mileage (KM)','Ignition', 'Parked For', '<?php echo $this->lang->line("Status"); ?>', '<?php echo "Data as of"; ?>','<?php echo $this->lang->line("Before"); ?>', '<?php echo $this->lang->line("In_Area"); ?>', '<?php echo $this->lang->line("Near Landmark"); ?>', '<?php echo $this->lang->line("Battery Status"); ?>','<?php echo $this->lang->line("Speed Limit Cross"); ?>'],
		colModel:[
