...
//			{name:"device_id",editable:true, index:"device_id", width:60, align:"left", jsonmap:"device_id"},
	...
	$("#sdate_data_logs").datetimepicker('setDate', new Date('<?php echo date("Y/m/d H:i:s",strtotime("12:00:00 am")); ?>'));
	$("#edate_data_logs").datetimepicker('setDate', new Date('<?php echo date("Y/m/d H:i:s",strtotime("11:59:59 pm")); ?>'));
...
<form onsubmit="return searchdata_logs()">
	...
	<tr>
		...
		<td width="20%"><?php echo $this->lang->line("Group"); ?> : <select
		onchange="AllPointfilterAssetsCombolog(this.value,'data_logs_device')"
		name="group" id="group_device_logs" class="select ui-widget-content ui-corner-all" style="width:200px"><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $group1; ?></select></td>
		<td width="20%"><?php echo $this->lang->line("Assets"); ?> : <select name="device_1" id="data_logs_device" class="select ui-widget-content ui-corner-all" style="width:200px"><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $devices; ?></select></td>
	</tr>
	<tr>
