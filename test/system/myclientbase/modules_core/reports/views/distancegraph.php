		...
		if(data.distance.length > 0){
			...
			/*plot2 = $.jqplot('distance_graph', data.distance, {
				...
				axes: {
					...
					yaxis: {
						label: '<?php echo $this->lang->line("Distance Travelled"); ?>',
						labelRenderer: $.jqplot.CanvasAxisLabelRenderer,
						tickRenderer: $.jqplot.CanvasAxisTickRenderer,
						tickOptions: {
				...
				axes: {
					...
					yaxis: {
						label: '<?php echo $this->lang->line("Distance Travelled(KM)"); ?>',
						labelRenderer: $.jqplot.CanvasAxisLabelRenderer,
						tickRenderer: $.jqplot.CanvasAxisTickRenderer,
						tickOptions: {
						  labelPosition:'middle'
  ...
  <form onsubmit="return searchdistancegraph()">
    <table width="100%" class="formtable" style="margin-bottom:5px;">
      <tr>
        ...
        <td width="14%"><?php echo $this->lang->line("Group"); ?> : <select onchange="filterAssetsCombo(this.value,'distance_report_device')" style="width:120px;" name="group" id="group_distance_graph" class="select ui-widget-content ui-corner-all" ><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $group; ?></select></td>
