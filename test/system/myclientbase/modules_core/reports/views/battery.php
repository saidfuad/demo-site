...
jQuery().ready(function (){
	...
	jQuery("#battery_grid<?php echo time(); ?>").jqGrid({
		...
		datatype: "json",
		colNames:["<?php $this->lang->line("ID"); ?>",'<?php echo $this->lang->line("Asset_Name"); ?>', '<?php echo $this->lang->line("Device Battery"); ?>', '<?php echo $this->lang->line("Vehicle Battery"); ?>'],
		colModel:[
		...
		multiselect: false, 
		sortorder: "asc",
		caption:"<?php echo $this->lang->line("Battery Report"); ?>",
...
<form onsubmit="return searchinspection()">
	<table border="5" width="100%" class="formtable" style="margin-bottom: 5px;">
		<tr>
			...
			<td width="30%"><?php echo $this->lang->line("Group"); ?> : <select onchange="filterAssetsCombo(this.value,'battery_device')" name="group" id="group_device_battery" class="select ui-widget-content ui-corner-all"  style="width:150px"><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $group; ?></select></td>
