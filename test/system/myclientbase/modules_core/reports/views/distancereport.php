...
<table width="100%" class="formtable" style="margin-bottom: 5px;">
	<tr>
		...
		<td width="14%"><?php echo $this->lang->line("Group"); ?> : <select onchange="filterAssetsCombo(this.value,'distancereportdevice')" style="width:120px;" name="group" id="group_distance_report" class="select ui-widget-content ui-corner-all" ><option value=''><?php echo $this->lang->line("Please Select"); ?></option><?php echo $group; ?></select></td>
