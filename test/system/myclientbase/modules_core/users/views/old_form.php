			...
			<table width="100%" align="center" class="formtable">
				<tbody>
					<tr>
						...
						<td width="50%"><label><?php echo $this->lang->line("password"); ?> *</label><input type="password" name="password" id="password" class="text ui-widget-content ui-corner-all" value="" />
						</td>
						<?php  }else { ?>
						<td width="50%"><label><?php echo $this->lang->line("password"); ?> </label><input type="password" name="password" id="password" class="text ui-widget-content ui-corner-all" value="" />
						</td>
					...
					<tr>
						...
						<td width="50%"><label><?php echo $this->lang->line("User Valid(To Date)"); ?></label><input type="text" name="to_date" id="to_date" class="date text ui-widget-content ui-corner-all" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="50%"><br/><input type="checkbox" style="width:11%" name="expiry_service_sms" id="expiry_service_sms" class="text ui-widget-content ui-corner-all" <?php echo ((isset($this->form_model->expiry_service_sms) && $this->form_model->expiry_service_sms==1) || (!isset($this->form_model->expiry_service_sms)))?"checked='checked'":""; ?> value=1 /><label>Service Expiry Sms</label></td>
						<td width="50%"><br/><input type="checkbox" style="width:11%" name="expiry_service_email" id="expiry_service_email" class="text ui-widget-content ui-corner-all" <?php echo ((isset($this->form_model->expiry_service_email) && $this->form_model->expiry_service_email==1) || (!isset($this->form_model->expiry_service_email)))?"checked='checked'":""; ?> value=1 /><label>Service Expiry Email</label></td>
					</tr> 
					<tr>
						<td width="50%"><br/><input type="checkbox" style="width:11%" name="show_owners" id="show_owners" class="text ui-widget-content ui-corner-all" <?php echo ((isset($this->form_model->show_owners) && $this->form_model->show_owners==1) || (!isset($this->form_model->show_owners)))?"checked='checked'":""; ?> value=1 /><label>Show Owners</label></td>
						<td width="50%"><br/><input type="checkbox" style="width:11%" name="show_divisions" id="show_divisions" class="text ui-widget-content ui-corner-all" <?php echo ((isset($this->form_model->show_divisions) && $this->form_model->show_divisions==1) || (!isset($this->form_model->show_divisions)))?"checked='checked'":""; ?> value=1 /><label>Show Divisions</label></td>
					</tr> 
					<tr>
						<td width="50%"><br/><input type="checkbox" style="width:11%" name="auto_refresh_setting" id="auto_refresh_setting" class="text ui-widget-content ui-corner-all" <?php echo ((isset($this->form_model->auto_refresh_setting) && $this->form_model->auto_refresh_setting==1) || (!isset($this->form_model->auto_refresh_setting)))?"checked='checked'":""; ?> value=1 /><label>Auto Refresh</label></td>
					</tr> 
					<tr>
