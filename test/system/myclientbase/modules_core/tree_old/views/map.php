...
/*
  ...
  */
  ...
  var lblOne1 = document.createElement('label')
  lblOne1.appendChild(document.createTextNode('Running  | '));
  lblOne1.style.paddingRight = '4px';
  lblOne1.style.color = 'green';
  controlUI.appendChild(lblOne1);
  /*var img1 = document.createElement('img');
  img1.setAttribute('src','<?php echo base_url(); ?>assets/images/running.png');
  img1.style.paddingRight = '4px';
  controlUI.appendChild(img1);
  */
  var lblOne2 = document.createElement('label')
  lblOne2.appendChild(document.createTextNode('Parked  | '));
  lblOne2.style.paddingRight = '4px';
  lblOne2.style.color = 'blue';
  controlUI.appendChild(lblOne2);
  /*var img2 = document.createElement('img');
  img2.setAttribute('src','<?php echo base_url(); ?>assets/images/running.png');
  img2.style.paddingRight = '4px';
  controlUI.appendChild(img2);
  */
  var lblOne3 = document.createElement('label')
  lblOne3.appendChild(document.createTextNode('Out Of Network  | '));
  lblOne3.style.paddingRight = '4px';
  lblOne3.style.color = 'orange';
  controlUI.appendChild(lblOne3);
  /*var img3 = document.createElement('img');
  img3.setAttribute('src','<?php echo base_url(); ?>assets/images/out_of_network.png');
  img3.style.paddingRight = '4px';
  controlUI.appendChild(img3);
  */
  
  var lblOne4 = document.createElement('label')
  lblOne4.appendChild(document.createTextNode('Out of network'));
  lblOne4.style.paddingRight = '4px';
  lblOne4.style.color = 'red';
  controlUI.appendChild(lblOne4);
  /*var img4 = document.createElement('img');
  img4.setAttribute('src','<?php echo base_url(); ?>assets/images/running.png');
  img4.style.paddingRight = '4px';
  controlUI.appendChild(img4);*/
}
...
function onLoadmap<?php echo time(); ?>() {
	...
	var trackNewWindowDiv = document.createElement('DIV');
	var trackNewWindowControl = new tripControl<?php echo time(); ?>(trackNewWindowDiv, map<?php echo time(); ?>);
	trackNewWindowDiv.index = 1;	
	map<?php echo time(); ?>.controls[google.maps.ControlPosition.TOP_RIGHT].push(trackNewWindowDiv);
	<?php } ?>
	...
	if(count($coords) > 0) {
			...
			foreach ($coords as $coord) {
				...
				$text .= "</b><br>";
				$text .= $coord->received_time.", ".date("d.m.Y h:i a",strtotime($coord->add_date))."<br>";
	...
	?>	
		...
		if(<?php echo $location_with_tag; ?> == 1){
			...
			*/
			var boxText = "<center><div style='width:40px; line-height: 10px; font-size: 12px; font-weight: bold; color: <?php echo $color; ?>; border: 1px solid black; background: none repeat scroll 0% 0% white; padding: 2px; margin-top: 0px;text-align:center;-moz-border-radius: 2px; border-radius: 2px;'>&nbsp;<?php echo $tag; ?></div></center>";
		...
		var content = "<img src='<?php echo base_url(); ?>assets/<?php echo $image_type; ?>' title='Click Me'>";
		...
		if($coord->lat_n != "" && $coord->lng_n != ""){	?>					
			...
			*/
		<?php }else{ ?>
			markersmap<?php echo time(); ?>.push(createMarkerMapAll(map<?php echo time(); ?>, point, "<?php echo $text; ?>", content ));
		<?php } ?>
			...
			if(lat.length > 0){
				for(i=0; i<lat.length; i++){
					...
					if(location_with_tag == 1){
						...
						*/
						var boxText = "<center><div style='width:40px; line-height: 10px; font-size: 12px; font-weight: bold; color: "+color+"; border: 1px solid black; background: none repeat scroll 0% 0% white; padding: 2px; margin-top: 0px;text-align:center;-moz-border-radius: 2px; border-radius: 2px;'>"+tag[i]+"</div></center>";
						var myOptions1 = {
							 content: boxText
							,disableAutoPan: false
							,maxWidth: 0
...
<div style='text-align: center;clear:both' id="refreshbar_id<?php echo $tme;?>">
	<div style="float:left;width:100%;height:2em;padding-top:0.2em"><input type='checkbox' onclick='stop_resume_toggle<?php echo $time; ?>()' id='timer_toggle<?php echo $time; ?>'> <?php echo $this->lang->line('data_refresh_after'); ?> <input type='text' size='2' onblur='counter_change<?php echo $time; ?>()' value='60' id='time_in_seconds<?php echo $time; ?>'> <?php echo $this->lang->line('seconds'); ?> <span style='display: inline-block;'>(<?php echo $this->lang->line('refresh_after'); ?> <span id='seconds<?php echo $time; ?>'>60</span><?php echo $this->lang->line('second'); ?>)</span> &nbsp;&nbsp;<span onClick="directRefreshMap()" style="font-weight:bold;text-decoration:underline;cursor:pointer"><?php echo $this->lang->line('refresh'); ?></span></div>
