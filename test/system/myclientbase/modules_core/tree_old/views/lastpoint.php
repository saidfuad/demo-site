...
jQuery().ready(function (){
	...
	jQuery("#treelastpoint_grid").jqGrid({
		...
		datatype: "json",
		colNames:["<?php echo $this->lang->line("ID"); ?>", '', '<?php echo $this->lang->line("Asset_Name"); ?>', 'Device ID', 'Friendly Name', 'AST_ID', 'Dev Status', 'Img', 'Direction', '<?php echo $this->lang->line("Datetime"); ?>', '<?php echo $this->lang->line("Address"); ?>', 'Latitude', 'Longitude', 'MImage', 'MText', '<?php echo $this->lang->line("Speed_KM"); ?>', 'Mileage (KM)', 'Ignition', 'Parked From', '<?php echo $this->lang->line("Status"); ?>', '<?php echo $this->lang->line("Before"); ?>', '<?php echo $this->lang->line("assets_division"); ?>', '<?php echo $this->lang->line("assets_owner"); ?>','<?php echo $this->lang->line("Before"); ?>', '<?php echo $this->lang->line("In_Area"); ?>', '<?php echo $this->lang->line("Near Landmark"); ?>', '<?php echo $this->lang->line("Battery Status"); ?>', '<?php echo $this->lang->line("alarm_type"); ?>', '<?php echo $this->lang->line("running_time"); ?>', '<?php echo $this->lang->line("message_cause"); ?>', '<?php echo $this->lang->line("Speed Limit Cross"); ?>'],
		colModel:[
			{name:"id",index:"id",hidden:true, width:15, jsonmap:"id"},
			{name:"assets_id",index:"assets_id",hidden:true, width:15, jsonmap:"assets_id"},
			{name:"am.assets_name", index:"am.assets_name", width:150, align:"center", jsonmap:"assets_name"},
	...
	jQuery("#treelastpoint_grid").jqGrid("navGrid", "#lastpoint_pager", {add:false, edit:false, del:false, search:false	}, {}, {}, {}, {multipleSearch:false});
...
//	var minutes = Math.floor(cellValue/60);
	...
	else if(minutes < <?php echo $network_timeout; ?>  && rowObject.speed == 0 && rowObject.ignition == 0){
		vehicleStatus = "Parked";
	}else if(minutes < <?php echo $network_timeout; ?> && rowObject.speed == 0 && rowObject.ignition == 1){
		vehicleStatus = "Idle";
	}else if(minutes > <?php echo $network_timeout; ?> && minutes < <?php echo ($network_timeout+36000); ?>){
...
//	var minutes = Math.floor(cellValue/60);
	var minutes = cellValue;
			if(minutes > <?php echo $network_timeout; ?>){
				color = "red";
			}else{
				color = "green";
			}
