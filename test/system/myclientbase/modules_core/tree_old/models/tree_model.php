...
class Tree_model extends Model 
{
	...
	*/
	...
	{
		$query = $this->db->query("select id, group_name, assets from group_master where status=1 AND del_date is null AND add_uid = $user");
		return $query->result();
