            ...
            return this.each(function () {
                ...
                var setFields = function () {
                    ...
                    if (settings.type === "single") {
                        ...
                        $('.number_of_sms').html(_single);
                        var cost_sms = parseFloat($('#sms-cost-h').val());
                        var ttl = cost_sms * parseFloat(_single);
                        $('#sms_cash').find('label').html('KES ' + ttl);
                       /* var sttls = $('#panel-sttls').find('.t');
                        var sttl_len = sttls.length;
                        var total_s = 0;

                        console.log($(sttl_len[0]).html());

                        for (var i=0; i<sttl_len; i++) {
                            //var amt = sttls[i].html().split(' ');
                                //amt = amt[1];
                        ...
                        $('#total_subs_hold').html('Total:' + total_s);
                        */
