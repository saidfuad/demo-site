...
class AfricasTalkingGateway {
	...
	public function __construct() {
		$this -> _username = "fahmy";
		$this -> _apiKey = "867936733d4f732c6ed0b87b30a10c5c72694a17a7636d0fb64957f06cc0b00b";
	...
	public function sendMessage($to_, $message_, $from_ = null, $bulkSMSMode_ = 1) {
		 ...
		 */
		$params = array('username' => $this -> _username, 'to' => $to_, 'message' => $message_, );
	...
	protected function setCurlOpts(&$curlHandle_) {
		...
		curl_setopt($curlHandle_, CURLOPT_HTTPHEADER, array('Accept: ' . self::AcceptType, 'apikey: ' . $this -> _apiKey));
	}
